...
export default function GetData() {
    ...
    const Fetchdata = async () => {
        ...
        await firebase.db.collection("coordinator").get()
            .then((querySnapshot) => {
        ...
        if (confirmBox == true) {
            await firebase.db.collection("coordinator").where("email", "==", name).get()
                .then(querySnapshot => {
                    ...
                    alert(" Coordinator Data Deleted Successfully");
    ...
    const handleUpdate = async (email) => {
        ...
        await firebase.db.collection("coordinator").where("email", "==", email).get()
            .then(querySnapshot => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (stext != "") {
            ...
            await firebase.db.collection("coordinator").where("name", "==", stext).get().then((querySnapshot) => {
            ...
            <div style={{ marginTop: '70px' }} className="container">
                ...
                <div className="row srow d-flex justify-content-end">
                    <form onSubmit={(e) => handleSubmit(e)}>
                        ...
                        <input class="form-control me-2 search_input" type="text" placeholder="Search Coordinator Data"
